...
public class Phase1_FloydWarshall {
    ...
    public Phase1_FloydWarshall() {
        ...
        graph = new int[][]{{INF, 10, INF, INF, INF, 5, INF, INF, INF, INF},
        {INF, INF, 3, INF, 3, INF, INF, INF, INF, INF},
        {INF, INF, INF, 4, INF, INF, INF, 5, INF, INF},
        {INF, INF, INF, INF, INF, INF, INF, INF, 4, INF},
        {INF, INF, 4, INF, INF, INF, 2, INF, INF, INF},
        {INF, 3, INF, INF, INF, INF, INF, INF, INF, 2},
        {INF, INF, INF, 7, INF, INF, INF, INF, INF, INF},
        {INF, INF, INF, 4, INF, INF, INF, INF, 3, INF},
        {INF, INF, INF, INF, INF, INF, INF, INF, INF, INF},
        {INF, 6, INF, INF, INF, INF, 8, INF, INF, INF}
        };
